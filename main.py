...
def main_menu() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="Заявка на бронирование")],  # Самая важная кнопка — на всю ширину
            [KeyboardButton(text="Номера"), KeyboardButton(text="Об отеле")],  # Номера подняли выше
            [KeyboardButton(text="Конференц-зал"), KeyboardButton(text="Частые вопросы")],  # В 2 колонки для компактности
            [KeyboardButton(text="Помощь")],
            [KeyboardButton(text="Контакты")]  # Контакты опустили в самый низ
        ],
        resize_keyboard=True,
        persistent=True,  # Фикс для iOS, чтобы меню не схлопывалось
...
def text_faq_breakfast():
    return (
        "🍽️ <b>Завтраки и Лобби-бар в отеле KOSTAS 4★</b>\n\n"
        "🍳 <b>Завтраки «шведский стол»</b>\n"
        ...
        "• <b>Будни:</b> с 07:30 до 11:00\n"
        "• <b>Выходные:</b> с 07:30 до 12:00\n"
        "• <b>Стоимость:</b> 1500 рублей (для детей до 2 лет — бесплатно).\n"
        "<i>Также доступен заказ ранних завтраков по меню a la carte в номер круглые сутки.</i>\n\n"
        "🍸 <b>Лобби-бар</b>\n"
        ...
        "📖 <a href='https://kostashotel.ru/restaurant/bar-2/'>Посмотреть меню лобби-бара</a>"
    )
...
def text_confrerence_room() -> str:
    return (
        "🏢 <b>Конференц-пространства отеля KOSTAS 4★</b>\n\n"
        "К вашим услугам 4 современные площадки (всего более 300 кв. м):\n"
        "• <b>Большой зал</b> (200 кв. м) — до 200 участников для масштабных событий.\n"
        "• <b>Конференц-фойе</b> (68 кв. м) — до 50 человек для велкам-зон и кофе-брейков.\n"
        "• <b>Малый зал</b> (50 кв. м) — до 32 гостей для камерных встреч и воркшопов.\n"
        "• <b>Переговорная</b> (24 кв. м) — до 12 человек для закрытых совещаний.\n\n"
        "🖥️ <b>Включено в стоимость:</b> проектор, экран, звукоусиление, микрофоны, кликер и Wi-Fi.\n"
        "🍽️ <b>Питание:</b> ресторанная служба организует кофе-брейки, ланчи и банкеты.\n\n"
        "📞 <b>Отдел мероприятий:</b> +7 (812) 710-24-22, +7 (921) 090-78-02\n"
        "📖 <a href='https://kostashotel.ru/restaurant/bar-2/'>Посмотреть меню лобби-бара</a>"
    )
